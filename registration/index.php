...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="#tour" class="w3-bar-item w3-button w3-padding-large w3-hide-small">Post List</a>
    <?php  if (isset($_SESSION['email'])) : ?>
    <a href="index.php?logout='1'" class="w3-bar-item w3-button w3-padding-large w3-hide-small">Logout</a>
    <a href="#band" class="w3-bar-item w3-button w3-padding-large w3-hide-small">Login name</a>
    <?php endif ?>
